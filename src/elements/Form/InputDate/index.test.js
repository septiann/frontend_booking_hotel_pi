...
test("Harus mempunyai wrapper dengan className .form-control", () => {
    const { wrapper } = setup();

    expect(wrapper).toBeInTheDocument()
})

test("Harus mempunyai tag <input> dan mempunyai className .form-control", () => {
    const { input } = setup()

    expect(input).toBeInTheDocument()
})

test("Harus memunculkan date picker ketika klik input field", () => {
